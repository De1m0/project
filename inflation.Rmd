...
# package::function
usethis::use_git_config(user.name = "Hannes Diemerling",user.email = "hannes.diemerling@gmail.com",init.defaultBranch = "main") # <-- not necessary but kinder than 'master'
```
...
And now i show you,that you can write in **bold** as well as in *italic* in Markdown.
